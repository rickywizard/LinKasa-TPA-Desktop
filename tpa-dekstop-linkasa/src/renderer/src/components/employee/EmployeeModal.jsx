...
const EmployeeModal = ({ isOpen, closeModal }) => {
  ...
  const handleRoleChange = async (e) => {
    ...
    const limitedRoles = ['csm', 'aom', 'fom', 'ghm', 'lom', 'mm', 'bssu', 'cm', 'lm', 'fm', 'cem', 'ceo', 'cfo', 'coo', 'cso']
      ...
      >
        <div className='bg-white p-6 rounded-md w-[36rem] overflow-hidden h-[36rem] overflow-y-auto'>
          <span className='flex justify-end'>
            <button onClick={handleCloseModal} className='text-gray-500 p-1 rounded-full hover:bg-gray-200'>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <button type='submit' className='mt-5 bg-green-500 w-full py-2 rounded-md text-center font-semibold text-white hover:bg-green-600'>
              Save
            </button>
          </form>
        </div>
